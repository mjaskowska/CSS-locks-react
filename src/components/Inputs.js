    ...
    return (
        ...
        <div className="container">
           ...
           <div className="input-container">
                ...
                <input type="text" value={minWidth} onChange={(e)=>setMinWidth(e.target.value)} placeholder="at width (px)"></input>
           </div>
           <h3 className="breakpoint-title">Higher breakpoint</h3>
           <div className="input-container">
                <label htmlFor="maxValue">font-size (px)</label>
                <input type="text" value={maxValue} onChange={(e)=>setMaxValue(e.target.value)} placeholder="value (px)"></input>
                <label htmlFor="maxWidth">at width (px)</label>
                <input type="text" value={maxWidth} onChange={(e)=>setMaxWidth(e.target.value)} placeholder="at width (px)"></input>
                
           </div>
           <Buttons passInfo={passInfo} setMinValue={setMinValue} setMaxValue={setMaxValue} setMinWidth={setMinWidth} setMaxWidth={setMaxWidth}/>
        </div>
